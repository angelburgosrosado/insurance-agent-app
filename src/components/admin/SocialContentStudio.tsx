...
import { generateCampaignPack, GeneratedCampaignPack, CampaignRequest } from "@/lib/ai-content-generator";
...
export function SocialContentStudio() {
  ...
  const handleGenerate = useCallback(() => {
    ...
    // Instant synthesis with smooth UI pulse
    setTimeout(() => {
  ...
  // Automatically update content whenever user changes parameters
  useEffect(() => {
    handleGenerate();
  }, [handleGenerate]);
      ...
      <div className="bg-[#001c38] text-white p-6 lg:p-8 space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-amber-500/20 border border-amber-500/40 text-amber-400 flex items-center justify-center shadow-inner">
              <Sparkles size={20} />
            </div>
            <div>
