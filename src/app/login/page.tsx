      ...
      <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-gray-100 text-center space-y-8">
        <div>
          ...
          <p className="text-gray-500">
            Sign in with your Google Workspace account to access the administration area.
          </p>
        </div>
        ...
        <Button
          onClick={handleLogin}
          size="lg"
          className="w-full bg-sentinel-navy hover:bg-sentinel-navy/90 text-white font-medium"
        >
